  ...
  updateScore = (id) => {
    ...
    //Else statement that determines what happens if they picked an image they have not picked before
      ...
      if (this.state.score === 11) {
        this.setState({ score: 0, highScore: 17, clickedCards: [], cards: cards })
        alert('You won!');
      }
    }
  }

  //Randomise the array of the cards
  randomCards = (array) => {
